...
cards:
  ...
  - title: loop statement
    description: loop statements are used to repeatedly execute a block of code, such as for, while, do-while, and enhanced for loop ("for-each" loop) which is used to iterate over a collection of elements.
  - title: toUpperCase()
